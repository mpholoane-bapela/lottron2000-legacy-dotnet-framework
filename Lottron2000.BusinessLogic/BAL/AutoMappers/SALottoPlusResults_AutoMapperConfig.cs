...
{
    public static class SALottoPlusResults_AutoMapperConfig
    {
        public static void CreateMap()
        {
            Mapper.CreateMap<SALottoPlusResult, LotteryNumbers>()
            ...
            .ForMember(dest => dest.CheckSumCount, opt => opt.MapFrom(src => src.SALottoPlusResultCheckSums.FirstOrDefault().ResultCheckSumSa.Count))
